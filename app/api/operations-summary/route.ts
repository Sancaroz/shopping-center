...
import { contactMessages, fulfillmentChecklists, notificationOutbox, orders, products, productVariants, returnRequests } from "../../../db/schema";
...
export async function GET() {
  ...
  const db=getDb();
  const [orderRows,productRows,variantRows,returnRows,messageRows,notificationRows,checklistRows]=await Promise.all([

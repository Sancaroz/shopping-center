...
import { cartItems, carts, inventoryMovements, notificationOutbox, orderItems, orders, products, promotionRedemptions, promotions, productVariants, shipmentEvents, storeSettings } from "../../../db/schema";

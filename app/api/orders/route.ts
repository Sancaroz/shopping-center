import { and, asc, desc, eq, exists, gte, isNull, lt, lte, or, sql } from "drizzle-orm";
...
export async function POST(request:Request) {
  ...
  try{await db.delete(cartItems).where(eq(cartItems.cartId,cart.id));}catch{}

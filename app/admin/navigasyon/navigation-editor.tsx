...
export default function NavigationEditor(){
  ...
  async function save(event:FormEvent<HTMLFormElement>){event.preventDefault();setBusy(true);const{response,data}=await updateSettings(values);setMessage(response.ok?"Üst menü güncellendi.":data.error??"Menü kaydedilemedi.");setBusy(false);}

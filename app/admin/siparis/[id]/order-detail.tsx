...
type Order = { id:number; orderNumber:string; market:string; status:string; customerName:string; email:string; phone:string; address:string; city:string; postalCode:string; country:string; note:string; subtotal:number; shippingAmount:number; total:number; createdAt:string; updatedAt:string };

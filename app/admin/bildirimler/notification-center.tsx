...
export default function NotificationCenter({isOwner}:{isOwner:boolean}) {
  ...
  return <main className="admin-shell notification-shell">
    <header className="admin-header"><div><p>MÜŞTERİ İLETİŞİMİ</p><h1>E-posta bildirimleri</h1></div><div><a href="/admin">Panele dön ↗</a>{isOwner&&<a href="/admin/yayina-hazirlik">Yayına hazırlık ↗</a>}</div></header>

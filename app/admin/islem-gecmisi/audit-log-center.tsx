...
const labels:Record<string,string>={"order.update":"Sipariş güncellemesi","return_request.update":"İade/iptal talebi","support.update":"Destek kaydı güncellemesi"};

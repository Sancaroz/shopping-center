...
type HomepageBlock={id:number;eyebrowTr:string;eyebrowEn:string;titleTr:string;titleEn:string;copyTr:string;copyEn:string;buttonTr:string;buttonEn:string;buttonUrl:string;imageUrl:string;imagePosition:string;marketTr:boolean;marketGlobal:boolean;active:boolean};
...
export default function Home() {
  ...
  const visibleHomepageBlocks=useMemo(()=>homepageBlocks.filter(block=>market==="TR"?block.marketTr:block.marketGlobal),[homepageBlocks,market]);

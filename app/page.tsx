    ...
    <main>
      ...
      <footer>
        <div className="footer-top">
          <div><a className="wordmark footer-logo" href="#top">{settings.brandName}<span>{settings.brandSuffix}</span></a><p>{settings.footerTagline||"Beautiful things for considered living."}</p></div>
